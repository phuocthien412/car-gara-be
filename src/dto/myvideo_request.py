...
class CreateMyVideoReqBody(BaseModel):
...
class UpdateMyVideoReqBody(BaseModel):
  id: str
  title: Optional[str] = None
  url: Optional[str] = None
  image: Optional[str] = None
...
class ListMyVideoReqQuery(BaseModel):
...
class DetailMyVideoReqParams(BaseModel):
  id: str


class DeleteOneMyVideoReqBody(BaseModel):
  id: str
...
class DeleteManyMyVideoReqBody(BaseModel):
  ids: List[str]
